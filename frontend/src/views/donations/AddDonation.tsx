...
const schema = yup.object().shape({
  ...
  amountMl: yup.number().required("Ilość oddanej krwi jest wymagana"),
  availableMl: yup.number().required("Ilość oddanej krwi jest wymagana"),
});
  ...
  return (
    <Container p={6} spacing={4} boxShadow="xl" rounded="md" bg="white">
      <form onSubmit={handleSubmit(onSubmit)}>
        <VStack spacing={4} align="flex-start">
          <FormControl
            id="donatorId"
            isRequired
            isInvalid={errors.donatorId && touchedFields.donatorId}
          >
          ...
          <FormControl
            id="amountMl"
            isRequired
            isInvalid={errors.amountMl && touchedFields.amountMl}
          >
          ...
          <FormControl
            id="availableMl"
            isRequired
            isInvalid={errors.availableMl && touchedFields.availableMl}
          >
      ...
      <Box mt="2">
        <Link
          as={RouterLink}
          to={routesDict.main.adminDonations.path}
          color="blue.500"
        >
