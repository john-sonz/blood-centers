...
export default function PrivilagesView() {
  const { data, isLoading, error } = useQuery("privilages", () =>
    axios.get<{ privilages: Privilage[] }>("/me/privilages")
  );
  ...
  return (
    <VStack w="100%">
      ...
      <VStack w="100%" spacing="5">
        {privilages.length === 0 && (
          <Text fontSize="lg">Brak przywilejów</Text>
        )}
        {privilages.map((priv) => (
          <Box
            w="60%"
